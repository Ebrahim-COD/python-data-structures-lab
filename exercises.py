...
def manage_students():
    ...
    student_names = ["Mohammed", "Ali" , "Hussain"]
    first_student = student_names[1]
...
def combine_foods():
    ...
    foods = ("Burger", "Steak" , "Pizza" , "Paste")
    meal = []
...
def hometown_info():
    ...
    house_town_message= f"I was born in {home_town.get('city')}, {home_town.get('state')} - population of {home_town.get('population')}"
    return house_town_message
# Call the function and print the result
